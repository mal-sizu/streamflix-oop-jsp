        ...
        <div class="auth-container">
            <div class="auth-form-container">
                ...
                <div class="auth-footer">
                    ...
                    <p class="small">By signing up, you agree to our <a href="${pageContext.request.contextPath}/terms.jsp">Terms of Use</a> and <a href="${pageContext.request.contextPath}/privacy.jsp">Privacy Policy</a>.</p>
                </div>
            </div>
        </div>
    </main>
